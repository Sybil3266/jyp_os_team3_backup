...
#define MAXUSERIDLENGTH 14  //ID �ִ� ���� 10
#define MAXUSERPASSWORDLENGTH 14  //password �ִ� ���� 10
#define MAXUSERCOUNT 128  //�� ���� �� 128��
...
// ���� ���� �����ϴ� ����ü
typedef struct kUserInformationStruct{
    WORD userCounter;
    WORD bUserAuthority;
    char UserID[MAXUSERIDLENGTH]; //14��
    char UserPassword[MAXUSERPASSWORDLENGTH]; //14��
} USERINFORMATION;
